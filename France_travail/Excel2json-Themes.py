...
def excel_to_json(excel_file, json_file):
    try:
        ...
        df = pd.read_excel(excel_file, sheet_name="Metier")
        ...
        print(f" Erreur : La feuille 'Metier' n'existe pas dans le fichier Excel ({ve})")
...
if __name__ == "__main__":
    ...
    excel_file_path = "/Users/Paq/Desktop/Projetchatbot/Excel-offres-themes.xlsx"
